...
<head>
    ...
    <style>
        ...
        .slide {
            ...
            filter: blur(5px);
            background-color: rgba(9, 9, 86, 0.5);
            /* Dark blue overlay */
        }
...
<body class="antialiased">
    ...
    <div class="slideshow-container">
        <div class="slides">
            <div class="slide" style="background-image: url('/images/gva_env/IMG_5300.jpg');"></div>
            <div class="slide" style="background-image: url('/images/gva_env/IMG_0852.jpg');"></div>
            <div class="slide" style="background-image: url('images/gva_env/IMG_0852.jpg');"></div>
        </div>
    </div>
    <div class="row align-content-center col-md-12">
        <div class="logo">
            <img src="/images/gva_logo/grand view-PNG.png" alt="Grandview Logo" class="logo-img">
        </div>
        <div class="content">
            ...
            <div class="static-text">
                Welcome to Grandview School Management System
            </div>
