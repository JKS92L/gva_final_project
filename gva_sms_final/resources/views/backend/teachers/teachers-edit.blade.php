                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="date" class="form-control form-control-sm" id="dob" name="dob"
                            value="{{ old('dob', $teacher->date_of_birth) }}" required>
                    </div>
                    <div class="form-group col-md-3">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="number" class="form-control form-control-sm" id="yearsExperience"
                            name="yearsExperience" value="{{ old('yearsExperience', $teacher->years_of_experience) }}"
                            required>
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control form-control-sm" id="qualifications"
                            name="qualifications" value="{{ old('qualifications', $teacher->qualifications) }}" required>
                    </div>
                    <div class="form-group col-md-3">
                        <label for="certifications">Certifications</label>
                        <input type="text" class="form-control form-control-sm" id="certifications"
                            name="certifications" value="{{ old('certifications', $teacher->certifications) }}">
                    </div>
                        ...
                        <select id="major_subject" name="major_subjects[]"
                            ...
                            @foreach ($subjects as $subject)
                                <option value="{{ $subject->id }}"
                                    {{ in_array($subject->id, $teacher->majorSubjects->pluck('id')->toArray()) ? 'selected' : '' }}>
                                    {{ $subject->short_code . ' ( CODE:' . $subject->subject_code . ' )- ' . ucfirst($subject->section) }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group col-md-3">
                        ...
                        <select id="minor_subject" name="minor_subjects[]"
                            ...
                            @foreach ($subjects as $subject)
                                <option value="{{ $subject->id }}"
                                    {{ in_array($subject->id, $teacher->minorSubjects->pluck('id')->toArray()) ? 'selected' : '' }}>
                                    {{ $subject->short_code . ' ( CODE:' . $subject->subject_code . ' )- ' . ucfirst($subject->section) }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="number" id="workingDaysCount" name="working_days_count"
                            ...
                            value="{{ old('working_days_count', $teacher->working_days) }}">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="time" id="workingStart" name="working_time_start"
                            ...
                            value="{{ old('working_time_start', \Carbon\Carbon::parse($teacher->working_hours_start)->format('H:i')) }}">
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="time" id="workingEnd" name="working_time_end"
                            class="form-control form-control-sm"
                            value="{{ old('working_time_end', \Carbon\Carbon::parse($teacher->working_hours_end)->format('H:i')) }}">
                    </div>
                ...
                <div class="row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control form-control-sm" id="username" placeholder="Username"
                            name="username" value="{{ old('username', $teacher->user->username) }}" required>
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control form-control-sm" id="status" name="status" required>
                            ...
                            <option value="Active" {{ $teacher->user->status == 'Active' ? 'selected' : '' }}>Active
                            </option>
                            <option value="Inactive" {{ $teacher->status == 'Inactive' ? 'selected' : '' }}>Inactive
                            </option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control form-control-sm" id="emergencyContactName"
                            placeholder="Contact Name" name="emergencyContactName"
                            value="{{ old('emergencyContactName', $teacher->emergency_contact_name) }}" required>
                    </div>
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control form-control-sm" id="emergencyContactRelation"
                            placeholder="Relationship" name="emergencyContactRelation"
                            value="{{ old('emergencyContactRelation', $teacher->emergency_contact_relation) }}" required>
                    </div>
                    <div class="form-group col-md-4">
                        <label for="emergencyContactPhone">Emergency Contact Phone</label>
                        <input type="tel" class="form-control form-control-sm" id="emergencyContactPhone"
                            placeholder="Phone Number" name="emergencyContactPhone"
                            value="{{ old('emergencyContactPhone', $teacher->emergency_contact_phone) }}" required>
                    </div>
                </div>
                <div class="text-center">
                    <button type="submit" class="btn  btn-success btn-sm w-50">Update</button>
                </div>
            </form>
