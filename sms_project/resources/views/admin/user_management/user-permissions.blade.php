...
@section('content_body')
    ...
    {{-- Example Edit Modal --}}
    <div class="modal fade" id="editRoleModal-1" tabindex="-1" role="dialog" aria-labelledby="editRoleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="#" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 text-bg-success accent-danger" id="editRolePermissions"
                                name="permissions[]" multiple="multiple" style="width: 100%;">
    ...
    <div class="modal fade" id="deleteRoleModal-1" tabindex="-1" role="dialog" aria-labelledby="deleteRoleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="#" method="POST">
